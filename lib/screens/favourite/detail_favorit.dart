...
//                                    child: Image.network(
//                                      'https://genius.remax.co.id/papi/Listing/crud/${snapshot.data['id']}/links/ListingFile/${fileImage}',
//                                      width: 10000,
//                                      fit: BoxFit.cover,
//                                    ),
//                                    onTap: () async {
...
//                                            'https://genius.remax.co.id/papi/Listing/crud/${snapshot.data['id']}/links/ListingFile/'),
//                                        context: context,
//                                      );
//                                    },
//                                  ),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                new Container(
                                  margin:
                                      EdgeInsets.only(top: 25.0, left: 15.0),
                                  child: new Row(
                                    children: <Widget>[
                                      new Text(
                                        "ID ",
...
//
//                                                            image: NetworkImage(
//                                                                'https://genius.remax.co.id/papi/Membership/crud/${snapshot.data['links']['listMmbsId']}/links/MembershipFile/${snapshot.data[0]}?size=256,256'))))
//                                                    : Container(
//                                                    margin: EdgeInsets.all(10),
//                                                    width: 80.0,
//                                                    height: 80.0,
