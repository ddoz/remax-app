...
class _DetailEditCustomerState extends State<DetailEditCustomer> {
  ...
  getProv() async {
    controllerProvince.text = await StateServiceProv.getProvNameById(
        widget.list[widget.index]['links']['custProvinceId']);
  }

  getCity() async {
    controllerCity.text = await StateServiceCity.getCityNameById(
        widget.list[widget.index]['links']['custCityId']);
  }

  getMarital() async {
    controllerMarital.text = await StateServiceMartial.getMaritalNameById(
        widget.list[widget.index]['links']['custMaritalStatusId']);
  }
  ...
  addData() async {
    ...
    if (validator() == "kosong") {
      ...
      final response = await http.put(
          "https://genius.remax.co.id/api/customer/crud/${idCustomer}",
          headers: headerss,
          body: body);
